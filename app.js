const policyItems = [
  {
    ...
    summary:
      "Use as the rights-based frame for Namibia's AI capacity-building agenda: accountability, transparency, inclusion, and human oversight.",
  ...
  },
  {
    ...
    summary:
      "Positions Namibia as a regional convening point for AI skills, STEM education, public-sector use cases, disaster risk, youth, and gender equality.",
  ...
  },
  {
    ...
    summary:
      "Government, academia, civil society, and private-sector actors met in Windhoek to support UNESCO's Readiness Assessment Methodology.",
  ...
  },
  {
    ...
    summary:
      "UNESCO-supported assessment identifies progress and persistent needs across policy, institutions, infrastructure, education, and public awareness.",
  ...
  },
  {
    ...
    summary:
      "A concrete model for one target group: policymakers and legal actors need AI literacy for oversight, evidence, rights, and procurement.",
  ...
  },
  {
    ...
    summary:
      "NCRST, UNAM, NUST, and a proposed institute can anchor coordination, curriculum design, applied pilots, and ethical review capacity.",
  ...
  },
  {
    ...
    summary:
      "A strong first-author angle: responsible AI capacity must include rural communities, local languages, indigenous knowledge, and public trust.",
...
const audiences = [
  {
    ...
    need: "Strategic capacity to decide what AI should be used for, what should be restricted, and who is accountable.",
    gap: "Policy coordination is ahead of implementation capacity: mandates, procurement rules, risk classification, and evaluation routines are still thin.",
    action: "Create a national AI governance curriculum: policy design, ethics, procurement, data protection, auditability, and sector-specific risk review.",
  },
  {
    id: "civil",
    ...
    need: "Operational capacity to use AI safely for administration, translation, records, analysis, citizen communication, and service delivery.",
    gap: "Most offices need practical guidance before tools spread informally: data handling, prompt literacy, verification, privacy, and escalation rules.",
    action: "Run short job-based modules with checklists, approved-use examples, red-line cases, and local-language public communication templates.",
  },
  {
    id: "citizens",
    ...
    need: "Public AI literacy so people can benefit from tools, spot misinformation, understand rights, and contest harmful automated decisions.",
    gap: "The biggest risk is exclusion: uneven connectivity, language barriers, low trust, and weak channels for community feedback.",
    action: "Use schools, libraries, radio, youth centres, and local authorities for public AI awareness in English and relevant local languages.",
  },
  {
    id: "education",
    title: "Educators and youth",
    summary: "Schools, teachers, TVET, universities, youth innovation programmes, and coding clubs.",
    need: "A skills pipeline from basic digital literacy to AI-adjacent skills: data, coding, critical thinking, ethics, and applied problem solving.",
    gap: "Training is likely concentrated near Windhoek and larger towns; teachers need usable materials before student-facing AI programmes scale.",
    action: "Build a trainer-of-trainers model, offline-first learning packs, AI clubs, TVET micro-credentials, and teacher guidance on safe classroom use.",
  },
  {
    id: "research",
    ...
    need: "Applied capacity to build, test, procure, and evaluate AI for Namibia's real sectors rather than importing generic solutions.",
    gap: "The ecosystem needs shared datasets, testbeds, ethics review routines, compute access, and stronger links between researchers and users.",
    action: "Create sector pilots around drought, water, logistics, tourism, mining safety, public health, and local-language services.",
  },
];
...
const componentLabels = {
  ...
  inclusionRiskIndex: "Rural inclusion risk",
};
...
const regions = [
  ...
  },
  {
    ...
    improve: [
      ...
      "Use Erongo as a demonstration region for sector-specific responsible AI use cases.",
    ],
  },
  {
    name: "Otjozondjupa",
      ...
      return `
        <g>
          <path
            ...
            tabindex="0"
            role="button"
            aria-label="${region.name}, ${level} priority, score ${score}"
          ></path>
...
function renderRegionDetail(region) {
  ...
  regionDetail.innerHTML = `
    <div class="score">
      <p class="eyebrow">${level} priority</p>
      <strong>${score}</strong>
    ...
    <ul class="detail-list">
      <li><b>What to improve first</b>${region.improve.join(" ")}</li>
    </ul>
  `;
}
...
function renderHeadline() {
  ...
  highestPriorityText.textContent = `${top.name} currently scores ${scoreFor(top)}/100 using the weighted formula: 30% connectivity gap, 25% skills pipeline, 20% institutional distance, 15% service pressure, and 10% inclusion risk.`;
}
...
async function copyBriefingNote() {
  ...
  const note = `Namibia AI Capacity-Building Tracker - draft briefing

Core framing: AI capacity building should not be treated as one generic training programme. The target groups are government leadership, civil servants, citizens and communities, educators and youth, and private-sector/research actors.

Core finding: Namibia has an active AI governance window after the UNESCO-supported AI Readiness Assessment, but capacity building should be sequenced before large-scale adoption.

Regional priority in this prototype: ${highPriority}.

Recommended output: a public-data policy report plus an interactive dashboard mapping who needs capacity, what the gap is, and which regional pilots can close it.`;

  await navigator.clipboard.writeText(note);
  copyBriefButton.textContent = "Copied";
  copyBriefButton.classList.add("copied");
  window.setTimeout(() => {
    copyBriefButton.textContent = "Copy briefing note";
