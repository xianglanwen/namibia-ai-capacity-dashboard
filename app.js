...
function renderHeadline() {
  ...
  highestPriorityText.textContent = `${top.name} shows the strongest need signal in this view, based on connectivity, youth literacy, distance from Windhoek, population pressure, and rural inclusion indicators.`;
}
